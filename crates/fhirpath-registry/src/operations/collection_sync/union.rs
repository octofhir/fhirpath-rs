//! Simplified union function implementation for FHIRPath
...
impl SimpleUnionFunction {
    pub fn new() -> Self {
        Self
    }
}

impl Default for SimpleUnionFunction {
    fn default() -> Self {
        Self::new()
    }
}

impl SyncOperation for SimpleUnionFunction {
    ...
    fn execute(
        ...
        // Combine both collections (union allows duplicates)
