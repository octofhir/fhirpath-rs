...
impl Default for FloorFunction {
    fn default() -> Self {
        Self::new()
    }
}
...
impl FhirPathOperation for FloorFunction {
    ...
    fn metadata(&self) -> &OperationMetadata {
        static METADATA: std::sync::LazyLock<OperationMetadata> =
            std::sync::LazyLock::new(FloorFunction::create_metadata);
        &METADATA
    }
    ...
    async fn evaluate(
        ...
        match &context.input {
            ...
            FhirPathValue::Decimal(n) => {
                Ok(FhirPathValue::Integer(n.floor().to_i64().unwrap_or(0)))
            }
    ...
    fn try_evaluate_sync(
        ...
        match &context.input {
            ...
            FhirPathValue::Decimal(n) => {
                Some(Ok(FhirPathValue::Integer(n.floor().to_i64().unwrap_or(0))))
            }
