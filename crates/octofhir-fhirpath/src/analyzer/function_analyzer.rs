...
impl FunctionAnalyzer {
    ...
    pub fn get_function_signature(&self, function_name: &str) -> Option<FunctionSignature> {
        ...
        match function_name {
            ...
            "getValue" | "htmlChecks" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 0,
                optional_args: 0,
                input_requirements: InputRequirement::Singleton,
                input_type: None,
                argument_types: vec![],
                return_type: if function_name == "htmlChecks" {
                    ReturnType::Boolean
                } else {
                    ReturnType::SameAsInput
                },
            }),
            "checkModifiers" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 0,
                optional_args: 10, // Variadic string args
                input_requirements: InputRequirement::Collection,
                input_type: None,
                argument_types: vec![ArgumentType::String],
                return_type: ReturnType::SameAsInput,
            }),
            "weight" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 0,
                optional_args: 0,
                input_requirements: InputRequirement::Singleton,
                input_type: None,
                argument_types: vec![],
                return_type: ReturnType::Type("Decimal".to_string()),
            }),
            "elementDefinition" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 0,
                optional_args: 0,
                input_requirements: InputRequirement::Singleton,
                input_type: None,
                argument_types: vec![],
                return_type: ReturnType::Type("ElementDefinition".to_string()),
            }),
            "slice" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 2,
                optional_args: 0,
                input_requirements: InputRequirement::Collection,
                input_type: None,
                argument_types: vec![ArgumentType::String, ArgumentType::String],
                return_type: ReturnType::SameAsInput,
            }),

            // Factory functions (%factory.*)
            "Extension" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 1,
                optional_args: 1,
                input_requirements: InputRequirement::Any,
                input_type: None,
                argument_types: vec![ArgumentType::String, ArgumentType::Any],
                return_type: ReturnType::Type("Extension".to_string()),
            }),
            "Identifier" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 2,
                optional_args: 2,
                input_requirements: InputRequirement::Any,
                ...
                return_type: ReturnType::Type("Identifier".to_string()),
            }),
            "HumanName" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 0,
                optional_args: 6,
                input_requirements: InputRequirement::Any,
                ...
                return_type: ReturnType::Type("HumanName".to_string()),
            }),
            "ContactPoint" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 2,
                optional_args: 1,
                input_requirements: InputRequirement::Any,
                ...
                return_type: ReturnType::Type("ContactPoint".to_string()),
            }),
            "Address" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 0,
                optional_args: 7,
                input_requirements: InputRequirement::Any,
                ...
                return_type: ReturnType::Type("Address".to_string()),
            }),
            "Coding" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 2,
                optional_args: 2,
                input_requirements: InputRequirement::Any,
                ...
                return_type: ReturnType::Type("Coding".to_string()),
            }),
            "Quantity" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 2,
                optional_args: 2,
                input_requirements: InputRequirement::Any,
                ...
                return_type: ReturnType::Type("Quantity".to_string()),
            }),
            "CodeableConcept" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 1,
                optional_args: 1,
                input_requirements: InputRequirement::Any,
                input_type: None,
                argument_types: vec![ArgumentType::Any, ArgumentType::String],
                return_type: ReturnType::Type("CodeableConcept".to_string()),
            }),
            "withExtension" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 2,
                optional_args: 1,
                input_requirements: InputRequirement::Any,
                input_type: None,
                argument_types: vec![ArgumentType::Any, ArgumentType::String, ArgumentType::Any],
                return_type: ReturnType::SameAsInput,
            }),
            "withProperty" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 3,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
            ...
            "serverCreate" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 1,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
                input_type: None,
                argument_types: vec![ArgumentType::Any],
                return_type: ReturnType::SameAsInput,
            }),
            "serverUpdate" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 1,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
            ...
            "serverDelete" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 1,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
            ...
            "serverSearch" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 2,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
                input_type: None,
                argument_types: vec![ArgumentType::Boolean, ArgumentType::Any],
                return_type: ReturnType::SameAsInput,
            }),
            "serverPatch" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 1,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
            ...
            "capabilities" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 0,
                optional_args: 1,
                input_requirements: InputRequirement::Any,
            ...
            "serverValidate" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 3,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
            ...
            "transform" => Some(FunctionSignature {
                ...
                input_requirements: InputRequirement::Any,
                input_type: None,
                argument_types: vec![ArgumentType::Any, ArgumentType::Any],
                return_type: ReturnType::SameAsInput,
            }),
            "everything" => Some(FunctionSignature {
                name: function_name.to_string(),
                required_args: 3,
                optional_args: 0,
                input_requirements: InputRequirement::Any,
            ...
            "apply" => Some(FunctionSignature {
                ...
                input_requirements: InputRequirement::Any,
                input_type: None,
                argument_types: vec![ArgumentType::Any, ArgumentType::Any, ArgumentType::Any],
                return_type: ReturnType::SameAsInput,
            }),
