...
//!
//! The supersetOf function returns true if the input collection is a superset of the other collection.
//! Syntax: collection.supersetOf(other)
...
impl PureFunctionEvaluator for SupersetOfFunctionEvaluator {
    async fn evaluate(
        ...
        Ok(EvaluationResult {
            value: crate::core::Collection::single(FhirPathValue::boolean(is_superset)),
        })
    }
