...
impl DiagnosticEngine {
    ...
    pub fn build_report(&self, diagnostic: &AriadneDiagnostic, source_id: usize) -> Result<Report<'static, (usize, Range<usize>)>, Box<dyn std::error::Error>> {
        ...
        // Add note with documentation link
    ...
    pub fn format_diagnostic(&self, diagnostic: &AriadneDiagnostic, source_id: usize) -> Result<String, Box<dyn std::error::Error>> {
...
impl ReportBuilder {
    ...
    pub fn with_related(mut self, message: String, span: Range<usize>, severity: DiagnosticSeverity) -> Self {
...
mod tests {
    ...
    fn test_report_builder() {
        ...
        assert_eq!(diagnostic.help, Some("Check available properties for Patient.name".to_string()));
        assert_eq!(diagnostic.note, Some("Property access must be valid according to FHIR specification".to_string()));
    }
