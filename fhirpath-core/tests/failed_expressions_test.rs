...
mod failed_expressions_tests {
    ...
    fn test_high_boundary_functions() {
        ...
        test_expression("1.highBoundary(0)", input.clone(), vec![FhirPathValue::Integer(2)]);
        test_expression(
            "120.highBoundary(2)",
            input.clone(),
    ...
    fn test_low_boundary_functions() {
        ...
        test_expression("1.lowBoundary(0)", input.clone(), vec![FhirPathValue::Integer(0)]);
        test_expression(
            "1.lowBoundary(5)",
            input.clone(),
            vec![FhirPathValue::Decimal(Decimal::from_str("0.5").unwrap())],
    ...
    fn test_plus_operations() {
        ...
        test_expression(
            ...
            input.clone(),
            vec![FhirPathValue::String("@1974-01-01T00:00:00.000+10:00".to_string())],
        );
        test_expression(
            "@1973-12-25T00:00:00.000+10:00 + 1 second",
            input.clone(),
            vec![FhirPathValue::String("@1973-12-25T00:00:01.000+10:00".to_string())],
        );
        test_expression(
            "@1973-12-25T00:00:00.000+10:00 + 10 millisecond",
            input.clone(),
            vec![FhirPathValue::String("@1973-12-25T00:00:00.010+10:00".to_string())],
        );
        test_expression(
            "@1973-12-25T00:00:00.000+10:00 + 1 minute",
            input.clone(),
            vec![FhirPathValue::String("@1973-12-25T00:01:00.000+10:00".to_string())],
        );
        test_expression(
            "@1973-12-25T00:00:00.000+10:00 + 1 hour",
            input.clone(),
            vec![FhirPathValue::String("@1973-12-25T01:00:00.000+10:00".to_string())],
        );
        test_expression(
            "@1973-12-25 + 1 day",
            input.clone(),
        ...
        test_expression(
            ...
            input.clone(),
            vec![FhirPathValue::String("@1973-12-25T00:00:00.100+10:00".to_string())],
        );
        test_expression(
