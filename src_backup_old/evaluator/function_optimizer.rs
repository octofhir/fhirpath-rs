...
use crate::model::{FhirPathValue, provider::ModelProvider};
...
mod tests {
    use super::*;
    use crate::model::{Collection, mock_provider::MockModelProvider};
    use tokio;
    ...
    async fn test_collection_count_optimization() {
        ...
        let context = EvaluationContext::new(
            FhirPathValue::Empty,
            Arc::new(crate::registry::FunctionRegistry::new()),
            Arc::new(crate::registry::OperatorRegistry::new()),
            mock_provider,
        );
