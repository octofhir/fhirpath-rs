...
pub enum ExtensionError {
    ...
    AlreadyRegistered { namespace: String },
    ...
    DependencyNotFound { namespace: String, dependency: String },
    
    /// Version compatibility error
    #[error("Extension '{namespace}' version '{version}' is not compatible with core version '{core_version}'")]
    VersionIncompatible {
        namespace: String,
        version: String,
        core_version: String,
