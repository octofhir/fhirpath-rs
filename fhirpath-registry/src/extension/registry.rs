...
impl ExtensionRegistry {
    ...
    pub fn register_metadata(&mut self, metadata: ExtensionMetadata) -> ExtensionResult<()> {
        ...
        self.functions_by_namespace.insert(metadata.namespace.clone(), HashSet::new());
        self.variables_by_namespace.insert(metadata.namespace.clone(), HashSet::new());
...
mod tests {
    ...
    fn test_function_registration() {
        ...
        assert!(registry.register_function("test", "myFunc", function).is_ok());
    ...
    fn test_function_finding() {
        ...
        registry.register_function("ext1", "common", function1).unwrap();
        registry.register_function("ext2", "common", function2).unwrap();
