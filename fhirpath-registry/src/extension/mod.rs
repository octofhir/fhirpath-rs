...
pub type VariableResolver = Arc<dyn Fn(&str, &EvaluationContext) -> Option<FhirPathValue> + Send + Sync>;
...
impl FunctionResolution {
    ...
    pub fn is_found(&self) -> bool {
        matches!(self, FunctionResolution::Core(_) | FunctionResolution::Extension { .. })
    }
}