...
use super::*;
use crate::function::{FunctionRegistry, EvaluationContext};
...
fn test_cache_size_limits() {
    ...
    // Verify eviction occurred (this is a basic test - proper LRU would need more sophisticated testing)
    let (resolution_stats, _) = registry.cache_stats();
...
fn test_cache_clearing() {
    ...
    registry.register_simple("clear_test", 1, Some(1), |_, _| Ok(FhirPathValue::Integer(42)));
